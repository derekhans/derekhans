...
**Enterprise Technology Leader | Identity · Security · Cloud · AI | Digital Transformation Strategist**

Nice to meet you! I’m a seasoned technology executive with 20+ years of experience driving strategic innovation across enterprise technology, cybersecurity, and cloud transformation. I thrive at the intersection of leadership, architecture, and execution with the purpose of translating vision into actionable solutions that deliver real-world value.
...
- Designed and implemented a "Our Way" Software Development Lifecycle, using state-of-the-art AI toolkits, chat and issue operational automation, infrastructure-as-code, and a single pipeline architecture for rapid development, deployment, and testing of software.
- Founded a Cloud Center of Excellence and delivered a multi‑cloud modernization strategy that generated $4M in annual cloud cost savings within a $45M spend.
- Modernized enterprise technology operations supporting 17,000+ retail locations, 36,000 employees, 100,000 partners, and 30M+ customers per year, improving performance and reliability at scale.
- Eliminated redundancies and optimized vendor portfolios, driving $35M+ in capital savings and $22M in recurring operational reductions.
- Increased enterprise satisfaction with technology services from 54% → 83% by aligning IT strategy with business goals, improving engagement models, and accelerating delivery.
- Architected and deployed a fully automated onboarding/offboarding pipeline, integrating HR and IT to deliver a seamless day‑one employee experience.
- Designed and implemented secure multi‑cloud AWS + Azure infrastructure with MFA, SSO, RBAC, and Terraform‑driven governance, strengthening security posture and operational consistency.
- Led identity modernization programs managing 20,000+ identities, reducing audit findings by 78%, cutting audit evidence collection time by 85%, and achieving compliance with HIPAA, PCI, GLBA, SEC 17a‑4, GDPR, and SOX.
- Reduced enterprise attack surface from hundreds of millions of vulnerabilities to ~3,000 and raised regulatory compliance to 98% through automation, monitoring, and configuration enforcement.
- Built automation platforms that reduced incident resolution times by 80% and increased user and customer satisfaction by 75%.
- Directed multi‑year datacenter modernization initiatives using both on-premise and public cloud networking, virtualization, storage, and platforms, while establishing a scalable, automated technology control framework.
- Provided leadership, planning and direction during restructuring and M&A activities, driving organizational redesign, policy development, contract negotiation, and budget planning.
- Led DevOps, developer experience, and cloud engineering teams delivering secure development platforms and high‑velocity software delivery pipelines.
...
- Microsoft Certified: **Cybersecurity Architect Expert**, **Azure Solutions Architect**, **DevOps Engineer Expert**
- Kepner-Tregoe: Strategic Alignment & Problem Solving
...
> _"Great tech isn't built by chance—it's built with clarity, strategy, and relentless execution."_
